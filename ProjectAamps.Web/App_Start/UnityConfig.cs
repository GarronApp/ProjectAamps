...
namespace AAMPS.Web.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            //container.RegisterType<DbContext, Aamps.Domain.Models.AampsContext>(new PerThreadLifetimeManager());
            //container.RegisterType<AAMPS.Clients.AampService.IAampService, AAMPS.Clients.AampService.AampServiceClient>(new InjectionConstructor());
        }
    }
}
