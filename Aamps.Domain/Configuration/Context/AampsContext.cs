...
using Aamps.Domain.Configuration;
...
using Aamps.Domain.Configuration.Mappings;

namespace Aamps.Domain.Configuration.Context
{
    public partial class AampsContext : DbContext
    {
        ...
        public DbSet<BondConditionTransaction> BondConditionTransactions { get; set; }
        ...
        public DbSet<OriginatorTransaction> OriginatorTransactions { get; set; }
        public DbSet<TransactionAtt> TransactionAtts { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //.Configurations.Add(new sysdiagramMap());
            ...
            modelBuilder.Configurations.Add(new TransactionAttMap());
