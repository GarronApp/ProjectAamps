...
{
    public class TransactionAttMap : EntityTypeConfiguration<TransactionAtt>
    {
        public TransactionAttMap()
        {
            // Primary Key
            ...
            this.HasRequired(t => t.Sale)
                .WithMany(t => t.TransactionAtts)
                .HasForeignKey(d => d.SaleID);
            this.HasRequired(t => t.UserList)
                .WithMany(t => t.TransactionAtts)
                .HasForeignKey(d => d.TransAttAddedByUser);
            this.HasRequired(t => t.UserList)
                .WithMany(t => t.TransactionAtts)
                .HasForeignKey(d => d.TransAttModifiedByUser);
